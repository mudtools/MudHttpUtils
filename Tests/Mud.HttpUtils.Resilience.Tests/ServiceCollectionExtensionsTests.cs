...
public class ServiceCollectionExtensionsTests
{
    ...
    private class TestEnhancedClient : IEnhancedHttpClient
    {
        ...
        public Task<FileInfo> DownloadLargeAsync(HttpRequestMessage request, string filePath, bool overwrite = true, int bufferSize = 81920, IProgress<long>? progress = null, CancellationToken cancellationToken = default)
