...
- 🏗️ **Interface-Level Dynamic Properties**: Define `[Query]`/`[Path]` properties on interfaces for global parameters
- 🗺️ **QueryMap**: Flatten objects/dictionaries into query parameters with serialization control
...
| Mud.HttpUtils.Abstractions | Interface definitions, minimal dependencies | [README](Mud.HttpUtils.Abstractions/README.md) |
