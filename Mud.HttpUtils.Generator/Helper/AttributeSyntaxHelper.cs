...
internal static class AttributeSyntaxHelper
{
    ...
    public static ImmutableArray<AttributeSyntax> GetAttributeSyntaxes<T>(
        T memberDeclaration,
        ...
        where T : MemberDeclarationSyntax
    {
        ...
        foreach (var attr in memberDeclaration.AttributeLists.SelectMany(al => al.Attributes))
        {
            if (attr.Name == null)
                continue;
            ...
            if (name.Equals(attributeName, StringComparison.Ordinal) ||
                name.Equals(attributeShortName, StringComparison.Ordinal))
            {
                builder.Add(attr);
            }
        }
