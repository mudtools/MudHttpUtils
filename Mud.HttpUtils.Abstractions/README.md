...
> 可观测性静态源放在 Abstractions 项目中，以便 `TokenManagerBase`、`EnhancedHttpClient`、`PollyResiliencePolicyProvider` 共用。配合 `Mud.HttpUtils.OpenTelemetry` 包可一键开启 Tracing + Metrics 导出。
